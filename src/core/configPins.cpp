...
void BruceConfigPins::fromFile(bool checkFS) {
    ...
    // Start this board from the compiled pin map until the display bring-up is stable.
    // Saved per-device overrides can carry stale values from other generic Bruce targets.
    {
