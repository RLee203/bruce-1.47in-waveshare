# Bruce 1.47in Waveshare

Waveshare ESP32-S3-LCD-1.47 Bruce port with the merged `Bruce-waveshare-esp32-s3-lcd-147.bin` included for direct flashing or Launcher install.
...
| [M5Stack M5StickC PLUS2](https://shop.m5stack.com/products/m5stickc-plus2-esp32-mini-iot-development-kit)  | :ok:      | :ok:         | :ok:      | :ok:      | :ok:  | :ok:Â¹     | :x:     | Tone      | :x:        | :x:       |
| [M5Stack M5StickC PLUS](https://shop.m5stack.com/products/m5stickc-plus-esp32-pico-mini-iot-development-kit)   | :ok:      | :ok:          | :ok:      | :ok:      | :ok:  | :ok:Â¹     | :x:     | Tone      | :x:        | :x:Â²     |
| [M5Stack M5Core BASIC](https://shop.m5stack.com/products/basic-core-iot-development-kit)    | :ok:        | :ok:       | :ok:       | :ok:        | :ok:  | :ok:Â¹     | :x:     | Tone      | :x:        | :x:       |
| [M5Stack M5Core2](https://shop.m5stack.com/products/m5stack-core2-esp32-iot-development-kit-v1-1)    | :ok:        | :ok:          | :ok:        | :ok:        | :ok:  | :ok:Â¹     | :x:     | :x:       | :x:        | :x:       |
...
| [JCZN CYD&#x2011;2432S028](https://www.aliexpress.us/item/3256804774970998.html)       | :ok:      | :ok:     | :ok:       | :ok:      | :x:   | :ok:Â¹     | :x:     | :x:       | :x:        | :x:Â²      |
...
Â² CYD have a LITE_VERSION version for Launcher Compatibility
Â¹ Core, CYD and StickCs Bad-USB: [here](https://github.com/pr3y/Bruce/wiki/Others#badusb)
